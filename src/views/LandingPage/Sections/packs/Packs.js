            ...
            <div className="col-lg-12">
              <div className="text-center mt-3">
                ...
                <div className="mt-4">
                  ...
                  <Link
                    to="#"
                    onClick={event => changeyears(event)}
                ...
                >
                  <div className="card-body text-center">
                    ...
                    <p>
                      ...
                      with your friends, teams without sharing email and
                      password.
                    </p>
              ...
              <div className="col-md-4">
                <div className="card card-pricing">
                  <div className="card-body text-center">
                    ...
                    <p>
                      Boost your productivity with bookmark, bulk session
                      creation and session timers. Assign different proxies
                      automatically to your sessions.
                    </p>
                    <ul className="card-pricing-features">
                      <li>
                        <img
                ...
                <div className="card card-pricing card-pricing-recommended">
                  <div className="card-body text-center">
                    ...
                    <p style={{ color: 'black' }}>
                      ...
                      block, website session access, session share under one
                      roof with making every session appear to have been started
                      from different browsers on different computers.
                    </p>
                    <ul className="card-pricing-features">
                      <li>
                        <img
